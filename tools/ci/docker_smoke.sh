...
# Substitute: hive, coworld-hive, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-hive:ci)
#   SMOKE_SLUG                 game slug                        (hive)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/hive)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/hive-player)
